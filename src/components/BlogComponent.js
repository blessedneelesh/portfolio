...
import { Card, CardImg, CardBody, CardTitle, CardSubtitle, CardText, Button, Media } from 'reactstrap'
            ...
            return (
                <div>
                    <Media key={blog.id} style={{ marginBottom: '20px' }}>
                        <Media>
                            <img src={blog.image} alt="Generic placeholder image" width='200' height='200' />
                        </Media>
